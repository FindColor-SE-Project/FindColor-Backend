...
class ObjectKind(Flag):
    ...
    to reflect tables and plain controllers ``ObjectKind.TABLE | ObjectKind.VIEW``
    may be used.
    ...
    .. note::
      ...
      check constraints of view return a dict with all the controllers with
...
class Inspector(inspection.Inspectable["Inspector"]):
    ...
    def has_table(
        ...
        .. versionchanged:: 2.0:: :meth:`.Inspector.has_table` now formally
           ...
           * any type of controllers (plain or materialized)
    ...
    def get_view_names(
        ...
        .. versionchanged:: 2.0  For those dialects that previously included
           the names of materialized controllers in this list (currently PostgreSQL),
           this method no longer returns the names of materialized controllers.
    ...
    def reflect_table(
        ...
        # NOTE: support tables/controllers with no columns
