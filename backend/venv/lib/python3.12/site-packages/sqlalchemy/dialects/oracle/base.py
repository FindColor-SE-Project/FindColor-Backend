...
class OracleDialect(default.DefaultDialect):
    ...
    def _has_table_query(self):
        # materialized controllers are returned by all_tables
        tables = (
            select(
    ...
    def _all_objects_query(
        ...
        # NOTE: materialized controllers are listed in all_objects twice;
    ...
    def get_table_names(self, connection, schema=None, dblink=None, **kw):
        ...
        # remove materialized controllers
        mat_query = select(
    ...
    def get_multi_table_options(
        ...
        **kw,
        ...
        if ObjectKind.VIEW in kind and ObjectScope.DEFAULT in scope:
            # add the controllers (no temporary controllers)
    ...
    def _column_query(self, owner):
        ...
        # NOTE: on oracle cannot create tables/controllers without columns and
        # a table cannot have all column hidden:
        # ORA-54039: table must have at least one column that is not invisible
        # all_tab_cols returns data for tables/controllers/mat-controllers.
    ...
    def _comment_query(self, owner, scope, kind, has_filter_names):
        ...
        if ObjectKind.TABLE in kind or ObjectKind.VIEW in kind:
            # all_tab_comments returns also plain controllers
            tbl_view = select(
    ...
    def get_multi_table_comment(
        ...
        **kw,
        ...
        # materialized controllers by default seem to have a comment like
