...
class MSSQLCompiler(compiler.SQLCompiler):
    ...
    def order_by_clause(self, select, **kw):
        ...
        # "The ORDER BY clause is invalid in controllers, inline functions,
...
class MSDialect(default.DefaultDialect):
    ...
    def _internal_has_table(self, connection, tablename, owner, **kw):
        if tablename.startswith("#"):  # temporary table
            # mssql does not support temporary controllers
            # SQL Error [4103] [S0001]: "#v": Temporary controllers are not allowed
            return bool(
                connection.scalar(
    ...
    def get_view_definition(
        ...
        view_def = connection.execute(
            sql.text(
                ...
                "join sys.controllers as controllers on mod.object_id = controllers.object_id "
                "join sys.schemas as sch on controllers.schema_id = sch.schema_id "
                "where controllers.name=:viewname and sch.name=:schname"
            ).bindparams(
