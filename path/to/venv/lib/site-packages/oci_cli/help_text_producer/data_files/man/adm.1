...
.
.TH "ADM" "1" "Dec 20, 2024" "3.51.1" "OCI CLI Command Reference"
.SH NAME
adm \- 
.
...
.SH DESCRIPTION
.sp
Use the Application Dependency Management CLI to create knowledge bases and vulnerability audits.  For more information, see \fI\%ADM\fP <\fBhttps://docs.cloud.oracle.com/Content/application-dependency-management/home.htm\fP>\&.
...
.nf
.ft C
oci adm vulnerability\-audit change\-compartment [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci adm vulnerability\-audit change\-compartment \-\-compartment\-id $compartment_id \-\-vulnerability\-audit\-id $vulnerability_audit_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci adm vulnerability\-audit create [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-application\-dependencies [complex type]
.UNINDENT
.sp
List of application dependencies (without vulnerabilities).
.sp
This option is a JSON list with items of type ApplicationDependency.  For documentation on ApplicationDependency please see our API reference: \fI\%https://docs.cloud.oracle.com/api/#/en/applicationdependencymanagement/20220421/datatypes/ApplicationDependency\fP\&.
This is a complex type whose value must be valid JSON. The value can be provided as a string on the command line or passed in as a file using
the \fI\%file://path/to/file\fP syntax.
.sp
The \fB\-\-generate\-param\-json\-input\fP option can be used to generate an example of the JSON which must be provided. We recommend storing this example
...
.UNINDENT
.sp
The compartment Oracle Cloud identifier (\fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP>) of the vulnerability audit. If compartment identifier is not provided the compartment of the associated knowledge base will be used instead.
.INDENT 0.0
.TP
...
.UNINDENT
.sp
This operation creates, modifies or deletes a resource that has a defined lifecycle state. Specify this option to perform the action and then wait until the resource reaches a given lifecycle state. Multiple states can be specified, returning on the first state. For example, \fB\-\-wait\-for\-state\fP ACTIVE \fB\-\-wait\-for\-state\fP FAILED would return on whichever lifecycle state is reached first. If timeout is reached, a return code of 2 is returned. For any other error, a return code of 1 is returned.
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
...
.ft C
    ...
    oci adm vulnerability\-audit create \-\-knowledge\-base\-id $knowledge_base_id
.ft P
.fi
.UNINDENT
.UNINDENT
.SS \fBcreate\-vulnerability\-audit\-external\-resource\-vulnerability\-audit\-source\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.nf
.ft C
oci adm vulnerability\-audit create\-vulnerability\-audit\-external\-resource\-vulnerability\-audit\-source [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci adm vulnerability\-audit create\-vulnerability\-audit\-external\-resource\-vulnerability\-audit\-source \-\-knowledge\-base\-id $knowledge_base_id
.ft P
.fi
.UNINDENT
.UNINDENT
.SS \fBcreate\-vulnerability\-audit\-oci\-resource\-vulnerability\-audit\-source\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.nf
.ft C
oci adm vulnerability\-audit create\-vulnerability\-audit\-oci\-resource\-vulnerability\-audit\-source [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-source\-oci\-resource\-id [text]
.UNINDENT
.sp
The Oracle Cloud identifier (\fI\%OCID\fP <\fBhttps://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm\fP>) of the OCI resource that triggered the vulnerability audit.
.SS Optional Parameters
.INDENT 0.0
.TP
.B \-\-application\-dependencies [complex type]
...
.ft C
    export compartment_id=<substitute\-value\-of\-compartment_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/adm/knowledge\-base/create.html#cmdoption\-compartment\-id
    export source_oci_resource_id=<substitute\-value\-of\-source_oci_resource_id> # https://docs.cloud.oracle.com/en\-us/iaas/tools/oci\-cli/latest/oci_cli_docs/cmdref/adm/vulnerability\-audit/create\-vulnerability\-audit\-oci\-resource\-vulnerability\-audit\-source.html#cmdoption\-source\-oci\-resource\-id

    knowledge_base_id=$(oci adm knowledge\-base create \-\-compartment\-id $compartment_id \-\-query data.id \-\-raw\-output)

    oci adm vulnerability\-audit create\-vulnerability\-audit\-oci\-resource\-vulnerability\-audit\-source \-\-knowledge\-base\-id $knowledge_base_id \-\-source\-oci\-resource\-id $source_oci_resource_id
.ft P
.fi
.UNINDENT
.UNINDENT
.SS \fBcreate\-vulnerability\-audit\-unknown\-source\-vulnerability\-audit\-source\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.nf
.ft C
oci adm vulnerability\-audit create\-vulnerability\-audit\-unknown\-source\-vulnerability\-audit\-source [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci adm vulnerability\-audit create\-vulnerability\-audit\-unknown\-source\-vulnerability\-audit\-source \-\-knowledge\-base\-id $knowledge_base_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci adm vulnerability\-audit delete [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci adm vulnerability\-audit delete \-\-vulnerability\-audit\-id $vulnerability_audit_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.nf
.ft C
oci adm vulnerability\-audit get [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci adm vulnerability\-audit get \-\-vulnerability\-audit\-id $vulnerability_audit_id
.ft P
.fi
.UNINDENT
.UNINDENT
...
.INDENT 0.0
.TP
.B \-\-max\-observed\-severity\-greater\-than\-or\-equal\-to [text]
.UNINDENT
.sp
...
.UNINDENT
.sp
The field used to sort Vulnerability Audits. Only one sort order is allowed. Default order for _maxObservedCvssV2Score_ is \fBascending\fP\&. Default order for _maxObservedCvssV3Score_ is \fBascending\fP\&. Default order for _maxObservedCvssV2ScoreWithIgnored_ is \fBascending\fP\&. Default order for _maxObservedCvssV3ScoreWithIgnored_ is \fBascending\fP\&. Default order for _timeCreated_ is \fBdescending\fP\&. Default order for _vulnerableArtifactsCount_ is \fBascending\fP\&. Default order for _vulnerableArtifactsCountWithIgnored_ is \fBascending\fP\&. Default order for _maxObservedSeverity_ is \fBascending\fP\&. Default order for _maxObservedSeverityWithIgnored_ is \fBascending\fP\&. Default order for _displayName_ is \fBascending\fP\&.
.sp
Accepted values are:
.INDENT 0.0
.INDENT 3.5
...
.UNINDENT
.UNINDENT
.SS \fBlist\-application\-dependency\-vulnerabilities\fP
.INDENT 0.0
.IP \(bu 2
\fI\%Description\fP
.IP \(bu 2
...
.nf
.ft C
oci adm vulnerability\-audit update [OPTIONS]
.ft P
.fi
.UNINDENT
.UNINDENT
...
.ft C
    ...
    oci adm vulnerability\-audit update \-\-vulnerability\-audit\-id $vulnerability_audit_id
.ft P
.fi
.UNINDENT
.UNINDENT
