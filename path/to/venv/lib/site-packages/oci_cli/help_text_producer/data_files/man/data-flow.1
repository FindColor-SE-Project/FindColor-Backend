...
.
.TH "DATA-FLOW" "1" "Dec 20, 2024" "3.51.1" "OCI CLI Command Reference"
.SH NAME
data-flow \- 
.
...
.SH DESCRIPTION
.sp
Use the Data Flow CLI to run any Apache Spark application at any scale without deploying or managing any infrastructure.
...
.UNINDENT
.sp
The input used for spark\-submit command. For more details see \fI\%https://spark.apache.org/docs/latest/submitting\-applications.html#launching\-applications\-with\-spark\-submit\fP\&. Supported options include \fB\-\-class\fP, \fB\-\-file\fP, \fB\-\-jars\fP, \fB\-\-conf\fP, \fB\-\-py\-files\fP, and main application file with arguments. Example: \fB\-\-jars oci://path/to/a.jar,oci://path/to/b.jar \-\-files oci://path/to/a.json,oci://path/to/b.csv \-\-py\-files oci://path/to/a.py,oci://path/to/b.py \-\-conf spark.sql.crossJoin.enabled=true \-\-class org.apache.spark.examples.SparkPi oci://path/to/main.jar 10\fP Note: If execute is specified together with applicationId, className, configuration, fileUri, language, arguments, parameters during application create/update, or run create/submit, Data Flow service will use derived information from execute input only.
.SS Optional Parameters
.INDENT 0.0
.TP
.B \-\-application\-log\-config [complex type]
